...
const AdminViewUsers = () => {
    ...
    return (
        <>
            <AdminHeader />
            <section className='section-profile shadow-2xl users-info w-[90%] md:[50%] lg:w-[60%] xl:w-[40%] mt-[5rem] mx-auto px-[4rem] py-[2rem] mb-[5rem] rounded-[10px] text-slate-800'>
                <div className=''>
